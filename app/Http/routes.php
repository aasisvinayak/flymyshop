...
Route::group(
    ['middleware' => 'menu'], function () {
          ...
          Route::get(
            ...
            Route::group(
                array('prefix' => 'account', 'middleware' => 'auth'), function () {
            ...
            Route::group(
                array('prefix' => 'shop', 'middleware' => array('auth', 'checkout')), function () {
            ...
            Route::group(
                array('prefix' => 'admin', 'middleware' => array('auth', 'admin')), function () {
